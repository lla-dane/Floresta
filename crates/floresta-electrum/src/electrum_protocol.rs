...
mod test {
    ...
    fn get_test_chain_state() -> Arc<ChainState<KvChainStore>> {
    ...
    fn get_test_node_interface(chain: &Arc<ChainState<KvChainStore>>) -> Arc<NodeInterface> {
    ...
    async fn start_electrum(port: u16) {
        ...
        let chain = get_test_chain_state();
        let node_interface = get_test_node_interface(&chain);
